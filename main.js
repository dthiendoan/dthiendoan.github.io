const effects = {
	...
	"bee": ["rest_sta", "rav_sta", "sta_reg", "weak_shock"],
	...
	"dwarven": ["weak_magic", "fort_ill", "mag_reg", "rest_mag"],
	"ecto": ["rest_mag", "fort_dest", "fort_mag", "dam_health"],
	"elves": ["rest_mag", "fort_mark", "weak_frost", "res_fire"],
	"parasol": ["dam_health", "fort_mag", "health_reg", "fort_two_h"],
	...
	"jazbay": ["weak_magic", "fort_mag", "mag_reg", "rav_health"],
	"juniper": ["weak_fire", "fort_mark", "health_reg", "dam_reg_sta"],
	"l_antler": ["rest_sta", "fort_sta", "slow", "dam_reg_sta"],
	"lavender": ["res_magic", "fort_sta", "rav_mag", "fort_conj"],
	"l_moth": ["dam_mag", "fort_light", "health_reg", "invisibility"],
	"moon_sugar": ["weak_fire", "res_frost", "rest_mag", "mag_reg"],
	"tapinella": ["rest_mag", "dam_ling_health", "sta_reg", "fort_ill"],
	"mudcrab": ["rest_sta", "cure_disease", "res_poison", "res_fire"],
	"namira": ["dam_mag", "fort_lock", "fear", "health_reg"],
	...
	"barnacle": ["dam_mag", "waterbreath", "health_reg", "fort_pick"],
	...
	"salmon_r": ["rest_sta", "waterbreath", "fort_mag", "mag_reg"],
	"salt": ["weak_magic", "fort_rest", "slow", "mag_reg"],
	"pholiota": ["weak_magic", "fort_ill", "sta_reg", "fort_carry"],
	...
	"taproot": ["weak_magic", "fort_ill", "mag_reg", "rest_mag"],
	...
	"v_dust": ["invisibility", "rest_mag", "health_reg", "cure_disease"],
...
const effects_label = {
	...
	"health_reg": "Regenerate Health",
	"mag_reg": "Regenerate Magicka",
	"sta_reg": "Regenerate Stamina",
